...
mod_language_ui <- function(id){
  ...
  language_list <- jsonlite::read_json("https://raw.githubusercontent.com/marton-balazs-kovacs/CorePrincipleGenAIChecklist/master/inst/app/www/language_list.json")
